...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/farms': { title: t('Farms') },
      '/info': { title: t('Overview'), description: 'View statistics for VBridge.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for VBridge.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for VBridge.' },
    },
    defaultTitleSuffix: t('VBridge'),
  }
}
