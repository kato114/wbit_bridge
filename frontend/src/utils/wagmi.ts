...
// @ts-ignore
const CHAINS = [valobit, bsc, avalandche, polygonMainnet]
...
export const { provider, chains } = configureChains(CHAINS, [
  jsonRpcProvider({
    rpc: (chain) => {
      if (!!process.env.NEXT_PUBLIC_NODE_PRODUCTION && chain.id === ether.id) {
...
export const coinbaseConnector = new CoinbaseWalletConnector({
  ...
  options: {
    appName: 'VBridge',
    appLogoUrl: 'https://wvbit.vbitbridges.com/logo.png',
  },
})
