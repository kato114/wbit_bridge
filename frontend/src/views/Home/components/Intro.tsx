    ...
    <Box mx="25px">
      <Flex py="50px" flexDirection={['column-reverse', null, 'row', 'row']}>
        ...
        <Flex flex="1" flexDirection="column" alignItems="center" p="30px">
          ...
          <Text textAlign="center" style={{ lineHeight: '1.7' }}>
            VBridges’s 1:1 swap enables users to perform 0 slippage transfers and eliminate the hidden cost associated
            with AMM.
          </Text>
        </Flex>
        <Flex flex="1" flexDirection="column" alignItems="center" p="30px">
          ...
          <Text textAlign="center" style={{ lineHeight: '1.7' }}>
            VBridge Router allows users to swap between any two chains freely. It reduces fees and makes it easier to
            move between chains.
          </Text>
        </Flex>
      </Flex>
