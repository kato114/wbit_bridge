...
export const WBNB = {
  ...
  [ChainId.VALOBIT]: new Token(
    ChainId.VALOBIT,
    '0x9Bf843B1BA38edd1D737D0728f1B999E984Fa3fc',
    18,
    'WVBIT',
    'Wrapped VBIT',
    'https://www.vbit.org'
...
export const WNATIVE: Record<number, Token> = {
  ...
  [ChainId.VALOBIT]: WBNB[ChainId.VALOBIT],
}
...
> = {
  [ChainId.VALOBIT]: { name: 'VBIT', symbol: 'VBIT', decimals: 18 },
