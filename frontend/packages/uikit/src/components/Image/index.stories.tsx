...
export const TokenImages: React.FC<React.PropsWithChildren> = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `http://wvbit.vbitbridges.com/images/tokens/${token.address[56]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `http://wvbit.vbitbridges.com/images/tokens/${token.address[56]}.png`;
        const secondarySrc = `http://wvbit.vbitbridges.com/images/tokens/${tokens[randomTokenIndex].address[56]}.png`;
